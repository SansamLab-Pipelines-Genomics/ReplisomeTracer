...
BED_OUTPUT="/s/sansam-lab/CS_20250702_Rep/ReplisomeTracer/DNAscent_Snakemake/results/forkSense/Aux_1/final_filtered.bed"

python /s/sansam-lab/path/to/scripts/filtered_bedfiles.py \
  --left "$LEFT_FORKS" \
  --right "$RIGHT_FORKS" \
  --origin "$ORIGIN" \
